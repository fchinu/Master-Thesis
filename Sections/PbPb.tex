...
\begin{table}[htb]
    ...
    \begin{tabular}{lcc|ccccc}
        ...
        \multirow{2}{*}{$\cos\theta_\mathrm{p}>$} & \multirow{2}{*}{4} & min & 0.9900 & 0.9980 & 0.9980 & 0.9800 & 0.9800 \\
        & & max & 0.9990 & 0.9995 & 0.9995 & 0.9950 & 0.9950 \\
        \multirow{2}{*}{$\cos\theta_\mathrm{p}^{xy}>$} & \multirow{2}{*}{4} & min & 0.9900 & 0.9970 & 0.9980 &0.9800 & 0.9800 \\
